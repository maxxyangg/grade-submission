...
public class GradeController {
    ...
    public ResponseEntity<Grade> createGrade(@Valid @RequestBody Grade grade, @PathVariable Long studentId,
    ...
    public ResponseEntity<Grade> updateGrade(@PathVariable Long studentId, @PathVariable Long courseId,
        ...
        return new ResponseEntity<>(gradeService.updateGrade(studentId, courseId, grade.getScore()), HttpStatus.OK);
    }

    @DeleteMapping("/student/{studentId}/course/{courseId}")
    public ResponseEntity<Grade> deleteGrade(@PathVariable Long studentId, @PathVariable Long courseId){
        return new ResponseEntity<>(gradeService.deleteGrade(studentId, courseId), HttpStatus.OK);
    }
